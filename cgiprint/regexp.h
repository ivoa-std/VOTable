 ...
 * All rights reserved.
 *.Mod 12-Apr-2010: if ending char not found, but NULL found ==> stop
 */

#ifndef _REGEXP_H
#define	_REGEXP_H

#pragma ident	"@(#)regexp.h	1.14	97/08/26 SMI"	/* SVr4.0 1.9	*/

#include <string.h>
#define step step_cgiprint		/* to avoid collision with step */
#define advance advance_cgiprint	/* to avoid collision with advance */
