...
\attrval{content-role}{doc} indicates documentation,
and in this case dereferencing the URI should yield a document
suitable for presentation to the user which describes the LINK's parent element;
appropriate behaviour for a client might be to pass the link to a browser
for presentation.
\attrval{content-role}{type} indicates a type-like
