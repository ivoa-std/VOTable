...
The \elem{TIMESYS} element defines such a time system and gives itself the identifies itself with \attrval{ID}{time\_frame}.
Then the \attr{obs\_time} \elem{FIELD} indicates that its values should be interpreted in that time system by referring
back to the \elem{TIMESYS} element using \attrval{ref}{time\_frame}.
