...
\begin{itemize}
  ...
  \item {\sf application/x-votable+xml; encoding=tabledata}
  \item {\sf application/x-votable+xml; encoding=TABLEDATA; charset=iso-8859-1}
\end{itemize}
...
\item The MIME type section (now \Aref{sec:mime}{section 8}) now describes
      the new {\tt encoding} parameter that can be used to specify
      serialization.
