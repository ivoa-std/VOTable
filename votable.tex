...
\urlthisversion{%\par\noindent {\bf This version:}\\
  %WD-VOTable-1.4-20190124
  \url{http://www.ivoa.net/Documents/VOTable/20190124/}} 
...
by its \A{http://www.ivoa.net/xml/VOTable/v1.4}{XML Schema}.
...
The XML Schema of this version 1.4 is included in 
...
VOTable to be pertinent for time-like quantities.
...
\url{http://www.ivoa.net/xml/VOTable/v1.4}
...
\ifhtx
\W{xsd}{http://www.ivoa.net/xml/VOTable/v1.4}
