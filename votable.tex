...
system. A \elem{TIMESYS} element referenced via a ref attribute MUST appear 
...
\ifhtx\A{http://ivoa.net/rdf/timescale}{vocabulary}.
\else
...
\ifhtx\A{http://ivoa.net/rdf/refposition}{vocabulary}.
\else
...
\item   \elem{COOSYS} is deprecated, in favor of a reference
        ...
        \ifhtx\A{http://ivoa.net/documents/Notes/VOTableSTC/}{Referencing STC in VOTable})
        \else{\it Referencing STC in 
