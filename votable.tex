...
\editor{Fran\c cois {Ochsenbein}\\
        ...
        Tom Donaldson}
\urlthisversion{
  \url{http://www.ivoa.net/Documents/VOTable/20190611/}} 
\urllastversion{
...
It is appropriate to reference this document only as a standard 
...
\ifhtx\A{http://www.ivoa.net/rdf/timescale}{vocabulary}.
\else
vocabulary\footnote{\url{http://www.ivoa.net/rdf/timescale}}.
\fi
...
\ifhtx\A{http://www.ivoa.net/rdf/refposition}{vocabulary}.
\else
vocabulary\footnote{\url{http://www.ivoa.net/rdf/refposition}}.
\fi
This attribute is mandatory.
\end{description}
...
\\ \hspace*{2em}{\url{http://www.ivoa.net/documents/DALI/}}
